          ...
          <View className="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 shadow-2xl">
            ...
            <View className="flex-row bg-slate-950 rounded-xl p-1 mb-6">
              <TouchableOpacity
                ...
                className={`flex-1 py-2.5 rounded-lg items-center ${!isEmailLogin ? 'bg-blue-600' : ''
                  }`}
              >
                <Text
                  className={`font-semibold text-sm ${!isEmailLogin ? 'text-white' : 'text-slate-400'
                    }`}
                >
                  Username
                </Text>
            ...
            <TouchableOpacity
              onPress={() => {
                console.log('[LoginScreen] Create New Account button pressed!');
                try {
                  router.push('/register');
                  console.log('[LoginScreen] Called router.push(\'/register\')');
                } catch (error) {
                  console.error('[LoginScreen] Error navigating to register:', error);
                }
              }}
              className="border border-slate-800 bg-slate-950/40 rounded-xl py-4 items-center justify-center mt-3 active:bg-slate-900/50"
            >
              <Text className="text-blue-400 text-base font-semibold">Don't have an account? Create Account</Text>
            </TouchableOpacity>
          </View>
