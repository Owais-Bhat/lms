      ...
      >
        ...
        >
          ...
          <View className="bg-slate-900/80 border border-slate-800 rounded-3xl p-6 shadow-2xl">
            ...
            <TouchableOpacity
              onPress={() => {
                console.log('[RegisterScreen] Already have an account? Sign In button pressed!');
                try {
                  router.replace('/login');
                  console.log('[RegisterScreen] Called router.replace(\'/login\')');
                } catch (error) {
                  console.error('[RegisterScreen] Error navigating to login:', error);
                }
              }}
            ...
            >
              <Text className="text-blue-400 text-base font-semibold">Already have an account? Sign In</Text>
            </TouchableOpacity>
          </View>
